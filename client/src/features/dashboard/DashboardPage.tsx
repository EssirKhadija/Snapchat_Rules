...
const metricCards = [
  ...
  { label: 'Dépenses',   value: `€${demoOverview.spend.toLocaleString()}`, sub: 'Total des dépenses',                      accent: false },
  { label: 'CTR',        value: `${demoOverview.ctr}%`,                   sub: 'Taux de clics',                            accent: false },
  { label: 'CPM',        value: `€${demoOverview.cpm.toFixed(2)}`,        sub: 'Coût pour mille',                          accent: false },
  { label: 'CPA',        value: `€${demoOverview.cpa.toFixed(2)}`,        sub: 'Coût par acquisition',                     accent: false },
  { label: 'ROAS',       value: `${demoOverview.roas.toFixed(1)}x`,       sub: 'Retour sur dépenses',                      accent: false },
];
